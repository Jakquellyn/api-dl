...
let final = () => {
    ...
    console.log(Bright("\nYou're now ready to start calestial. Simply run ") + Cyan("npm start") + Bright('!\nHave fun :)'));
    rl.close()
}

console.log(
    `${Cyan(`Hey, this is calestial v.${version}!`)}\n${Bright("Let's start by creating a new ")}${Cyan(".env")}${Bright(" file. You can always change it later.")}`
)
